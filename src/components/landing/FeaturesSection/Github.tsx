...
export default function Github({ className }: GithubProps) {
  ...
  const githubStatsUrl = (type: 'overview' | 'languages') =>
    `https://raw.githubusercontent.com/www-chengxuyuancd-com/github-stats/master/generated/${type}.svg#gh-${
  ...
  return (
    <div className={className}>
      ...
      <div className="relative flex w-full flex-col items-center justify-center overflow-hidden bg-background">
        ...
        <GitHubCalendar username="www-chengxuyuancd-com" blockSize={11} colorScheme={isDarkTheme ? 'dark' : 'light'} />
      </div>
    </div>
  )
}
