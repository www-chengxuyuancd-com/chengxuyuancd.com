...
function Name() {
  return (
    ...
    >
      <Translate id="homepage.hero.greet">你好! 这里是</Translate>
      <span
      ...
      >
        <Translate id="homepage.hero.name">程序员充电站</Translate>
      </span>
      ...
      <div className={styles.intro}>
        ...
        <motion.p custom={2} initial="hidden" animate="visible" variants={variants} className="max-md:px-4">
          <Translate id="homepage.hero.text">
            小站会围绕程序员职业-副业-创业相关的话题进行分享，带你了解从 0-1构建项目，从 1 - ∞进行推广，以及我尝试过且有结果的路子。
          </Translate>
        </motion.p>
        ...
        <motion.div className="mt-4 flex gap-2" custom={4} initial="hidden" animate="visible" variants={variants}>
          ...
          >
            <a href={'/about'} className="font-semibold">
              <Translate id="hompage.hero.introduce">小站介绍</Translate>
            </a>
          </MovingButton>
        </motion.div>
      </div>
