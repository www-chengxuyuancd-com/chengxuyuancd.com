...
const ADD_FRIEND_URL = 'https://github.com/www-chengxuyuancd-com/chengxuyuancd.com/edit/main/data/friends.tsx'
const SITE_INFO = `
title: '程序员充电站',
description: '志之所趋，无远弗届，穷山距海，不能限也。',
website: 'https://chengxuyuancd.com',
avatar: 'https://chengxuyuancd.com/img/logo.png',
`
