export const projects: Project[] = [
  ...
  // cv
  {
    ...
    preview: '/img/project/niaowo.png',
    website: '',
  ...
  },
  {
    ...
    preview: '/img/project/zhizhen-shibie.jpg',
    website: '',
    source: 'https://github.com/www-chengxuyuancd-com/',
    tags: ['partially_opensource', 'computer_vision', 'commerce'],
    type: 'cv',
  },
  {
    ...
    preview: '/img/project/hand-written-chars.jpg',
    website: '',
    source: 'https://github.com/www-chengxuyuancd-com/',
    tags: ['partially_opensource', 'computer_vision', 'commerce'],
    type: 'cv',
  ...
  // pachong
  {
    ...
    preview: '/img/project/caipiao.png',
    website: '',
    source: 'https://github.com/www-chengxuyuancd-com/',
  ...
  },
  {
    ...
    preview: '/img/project/email-sending.png',
    website: '',
    source: 'https://github.com/www-chengxuyuancd-com/',
  ...
  },
  {
    ...
    preview: '/img/project/keyan-1.png',
    website: '',
    source: 'https://github.com/www-chengxuyuancd-com/',
    tags: ['opensource', 'favorite'],
    type: 'spider',
